/* tslint:disable */
/**
 * временный фикс типов для jest при переходе на 3.3.1, interface MockInstance,
 * из-за того что добавили второй аргумент в интерфейсе. Ts-jest его не прокидывает.
 * TODO: удалить с повышением версии ts-jest
 */
